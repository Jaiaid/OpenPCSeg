...
class SemkittiCarlaVoxelDataset(data.Dataset):
    def __init__(
        self,
        data_cfgs=None,
        training=True,
        ...
        self.point_cloud_dataset = SemantickittiCarlaDataset(
            data_cfgs=data_cfgs,
            training=training,
    ...
    def get_single_sample(self, index, voting_idx=0):
        ...
        # print(self.training, len(inds) , self.num_points, self.training and len(inds) > self.num_points)
